...
| [`runbooks/habilitar-login-google.md`](runbooks/habilitar-login-google.md) | **"Entrar com Google" devolve `provider is not enabled`** — habilitar o provedor OAuth no Supabase, por instalação |
